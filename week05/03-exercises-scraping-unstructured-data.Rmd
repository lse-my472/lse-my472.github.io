...
```{r}
first_caption_element <- html_noether %>% html_elements(css = ________)
...
```{r}
all_lhs_caption_elements <- html_noether %>% html_elements(css = ________)
...
```{r}
label_elements_feynman <- html_feynman %>% html_elements(css = ________)
