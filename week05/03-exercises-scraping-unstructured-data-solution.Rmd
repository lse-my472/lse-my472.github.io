...
```{r}
first_caption_element <- html_noether %>% html_elements(css = "div.mw-parser-output > figure:nth-child(11)") #inspected in Google Chrome 10/23/2023
...
```{r}
all_caption_elements <- html_noether %>% html_elements(css = "figcaption") #source viewed in Google Chrome 10/23/2023
...
```{r}
all_lhs_caption_elements <- html_noether %>% html_elements(css = ".mw-halign-left figcaption") #source viewed in Google Chrome 10/23/2023
