...
```{r}
first_caption_element <- html_noether %>% html_elements(css = "div.thumb:nth-child(11) > div:nth-child(1) > div:nth-child(2)")
...
```{r}
all_caption_elements <- html_noether %>% html_elements(css = ".thumbcaption")
...
```{r}
all_lhs_caption_elements <- html_noether %>% html_elements(css = ".thumb.tleft .thumbcaption")
