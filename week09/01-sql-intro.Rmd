...
for (f in fls){
  ...
  fb <- invisible (read.csv(f, stringsAsFactors = FALSE))
...
And then two important query clauses that we will introduce in the next coding exercise:  
...
# OR operator -- note the importance of the parentheses. What happens if you remove them?
