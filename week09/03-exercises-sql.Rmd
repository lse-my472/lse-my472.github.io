---
title: "MY472 - Week 9: Seminar exercises in creating and querying SQLite databases"
...
Lastly, the task is to create a simple new SQLite database with one table and query it. The data will be a random sample of 10,000 tweets related to the 2014 EP elections in the UK which can be found in `UK-tweets.csv`.
