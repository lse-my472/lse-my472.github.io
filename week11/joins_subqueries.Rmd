...
In class we learned simple join. Sometimes, for some of the rows you are joining, you may not be able to find matching records in another table. In that case, you still want to keep the records from one table after JOIN. In this challenge, we will learn how to do that. 

The following figure shows different types of joins and how to run the query for each type.

![joins](joins.png)

## Curtailed Facebook dataset
