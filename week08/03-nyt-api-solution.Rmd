...
author: "Pablo Barberá, Friedrich Geiecke, Daniel de Kadt"
...
```{r}
readRenviron("YOUR .env FILE HERE")
apikey <- Sys.getenv("WHATEVER NAME YOU SAVED YOUR KEY AS IN THE .env FILE")
```
...
Question: Between these two dates, how many articles in the NYT mentioning "inequality"? 1462.
