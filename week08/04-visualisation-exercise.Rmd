...
p <- ggplot(unemp, aes(x = date, y = unemp)) + geom_line()

p

# Fix axes and add colored rectangles
p + scale_x_date(limits= xrange, expand = c(0,0))

p + geom_line() + scale_x_date(date_breaks = "20 years")

p +  geom_rect(data=pres, aes(ymin=0, ymax=0.12, )
