...
Before we look at real-world examples, let us first study our own simple files.
...
The data frame contained in the MT key:

```{r}
example_3_parsed$MT
```

The data frame contained in the LT key:
