...
```{r}
# This focuses the browser on the <body> of the script
webElem <- driver$findElement("css", "body")

# When you hit space, you scroll down
...
search_field <- driver$findElement(using = 'class name', value = '______________')
