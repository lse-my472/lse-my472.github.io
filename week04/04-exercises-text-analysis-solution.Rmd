...
print(raw) # this is Japanese
my.utf.file <- "data/news-article-1-utf8.txt"
...
for(document in data_char_ukimmig2010){
  print(str_sub(document, 1,80)) ## There are a bunch of ways to do this!
}
...
for(party in names(data_char_ukimmig2010)){
  print(paste0(party,": ",str_sub(data_char_ukimmig2010[party], 1,80))) ## There are a bunch of ways to do this!
}
```
