...
This Rmarkdown script provides a description of some of the building blocks we will rely on throughout this course. If you're having trouble following the code below, make sure you have finished the R preparatory course and read the required chapters in Wickham's *Advanced R*.
