...
::: {.callout-warning}
GitHub does not allow you to push files from your local repo that are too large. You can read about the file size limits [here](https://docs.github.com/en/repositories/working-with-files/managing-large-files/about-large-files-on-github). Any file that  is greater that 50MB on your computer should not be tracked by Git or pushed to GitHub. Always add these files to a `.gitignore`. 
:::
...
The dataset is available on the website at <https://lse-my472.github.io/week03/tb_data.csv>. Write a code chunk that downloads this file and saves it to your local Seminar 3 repo. The chunk should only download the file if it does not already exist in the directory.
