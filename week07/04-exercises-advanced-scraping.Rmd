...
src <- driver$________() # Hint: look up how to get the page source in the help documents for RSelenium: https://cran.r-project.org/web/packages/RSelenium/index.html
...
accept_button <- driver$findElement(using = "xpath", value = ________)

# 2. Click on the button:
accept_button$________()
Sys.sleep(0.5)
...
search_field_xpath <- ________ 

# 2. Using this XPath, find the node on the page
search_field <- driver$________(using = 'xpath', value = search_field_xpath)

# 3. send a post code to the search field
search_field$________(list("WC2A2AE"))
