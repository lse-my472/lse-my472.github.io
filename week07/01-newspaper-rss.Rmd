...
Before scraping, we can check the structure of the xml document on the browser. We need to know what the element for each article is called and find the xml tag item. Now we read in the document and extract these elements.
