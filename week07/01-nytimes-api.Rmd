...
apikey <- "JvCG6mSG7k8SMV4b08Zeuorfqa91DkjJ"
```
...
From the output of `r`, we can see that the query was successful (`Status: 200`), the content is in `json` format, and its size is `203 kB`.
