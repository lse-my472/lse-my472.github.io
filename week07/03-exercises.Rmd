...
#match a-z, either one or two letters, numbers 0-9 (either 1 or 2), the space as well is either zero or 1
...
#another example-- double back slashed in \, need to change in atom
#([A-Z]{1,2}\\d{1,2})
```
...
```{r}
#follows the pattern
#second half of group [0-9][A-Z]{2}
#to replace:

str_replace_all([0-9][A-Z]{2})
