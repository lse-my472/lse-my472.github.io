---
title: "Creating and querying a SQL database"
...
We'll start by connecting to the database and adding the first table, with information at the level of member of congress. 
