---
title: "MY472 - Week 10: Creating and querying a database in the cloud"
...
project_name <- "class-demonstration-my472-2023"

# Billing (project ID)
billing_id <- "class-demonstration-my472-2023"

# Dataset name (created on website)
dataset_name <- "my472_example"
```
