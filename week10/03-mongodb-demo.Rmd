...
author: "Pablo Barberá, Friedrich Geiecke, Akitaka Matsuo"
...
This document is __optional__ in the course. If you would like to run the code yourself, you can follow the following instructions:

Although we use MongoDB through R, we first need to install the software and run it in the background. If you are using a **Mac**, the following can be run in terminal.
