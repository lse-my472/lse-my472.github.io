...
In the the tidyverse, data frames are often processed as so called tibbles. This allows to depict them in a more convenient form, e.g. in the console and the knitted R markdowns.
