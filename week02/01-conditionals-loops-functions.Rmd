...
author: "Ken Benoit, Friedrich Geiecke, Thomas Robinson"
date: "October 2023"
...
A multi-condition version of `ifelse` which is nevertheless vectorised is the `case_when` function from the **dplyr** package:
```{r}
