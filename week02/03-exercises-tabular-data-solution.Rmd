---
title: "MY472 - Week 2: Seminar exercises in tabular data - solution"
...
(_Optional_: Calculate the year-to-year difference in each of unemployment rate and industrial production for those months with available data for both time series in 2019 and 2020. Note that there are several ways to do this computation, some can be simpler than the solution sketch here)
